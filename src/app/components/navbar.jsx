...
const Navbar = () => {
  ...
  return (
    <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
      ...
      <div className="hidden md:flex gap-6 w-1/3 items-center justify-center">
        <Link href="https://github.com/shakilurrehman21" target="_blank">
          <Image src="/github.png" alt="GitHub" width={24} height={24} />
        </Link>
        <Link href="https://leetcode.com/shakilurehman/" target="_blank">
          <Image src="/leetcode.png" alt="Leetcode" width={24} height={24} />
        </Link>
        <Link href="https://www.linkedin.com/in/shakilurrehman21/" target="_blank">
